...
import 'package:flutter/foundation.dart' show kIsWeb; // for platform conditional
...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin {
  ...
  final bool _loginButtonPressed = false;
  ...
  Future<void> _signInWithGoogle() async {
    try {
      ...
      final googleSignIn = (kIsWeb || Platform.isWindows || Platform.isLinux || Platform.isMacOS)
          ? GoogleSignIn(clientId: googleWebClientId, scopes: ['email', 'profile'])
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    ...
                    // Simulate login
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Logged in as Guest User')),
                    );
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const HomeScreen(userId: 0, userName: 'Guest User'),
                      ),
                    );
                  },
                  child: Padding(
                ...
                InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: const [
                        Icon(Icons.person_add_outlined, color: Colors.black54),
                        SizedBox(width: 16),
                        Text(
                          'Use another account',
                          style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                ...
                children: [
                   ...
                   SizedBox(
                     ...
                     child: OutlinedButton.icon(
                        ...
                        onPressed: _showFakeGoogleDialog, // Mock demo dialog
