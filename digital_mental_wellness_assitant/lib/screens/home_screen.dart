                              ...
                              child: Center(
                                child: isToday
                                    ? Column(mainAxisSize: MainAxisSize.min, children: const [
                                        ...
                                        SizedBox(height: 6),
                                        Text('Today', style: TextStyle(fontSize: 12, color: Colors.purple)),
                                      ])
                                    : (isPast
                                        ? const Text('No log', style: TextStyle(fontSize: 12, color: Colors.black38))
                                        : const Text('—', style: TextStyle(fontSize: 12, color: Colors.black26))),
                              ),
                            ),
                          ),
                          const SizedBox(height: 8),
