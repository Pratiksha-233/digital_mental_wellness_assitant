          ...
          children: [
            ...
            Expanded(
              child: FutureBuilder<List<dynamic>>(
                future: ApiService().getMoodLogs(userId: 1),
                builder: (context, snap) {
                  final mapByDate = <String, String>{};
                  if (snap.hasData) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      final emoji = mapByDate.containsKey(key) ? mapByDate[key] : (isPast ? '😐' : null);
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (isToday) ...[
                                ...
                                Text(isPast ? '😐' : '—', style: TextStyle(fontSize: 11, color: isPast ? Colors.black38 : Colors.black26)),
                            ],
                          ),
                        ),
                      );
