...
from services.db_service import insert_full_mood_log, get_mood_logs_by_user
...
def log_mood():
    ...
    ok, err = insert_full_mood_log(user_id, mood_label, energy_level, activities_serialized, note)
    if not ok:
